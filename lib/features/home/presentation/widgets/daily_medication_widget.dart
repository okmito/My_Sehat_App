...
class _DailyMedicationWidgetState extends ConsumerState<DailyMedicationWidget> {
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: _timeOfDayColor.withValues(alpha: isDark ? 0.2 : 0.1),
                  borderRadius: BorderRadius.circular(12),
                  border: Border.all(
                    color: _timeOfDayColor.withValues(alpha: isDark ? 0.3 : 0.2),
                  ),
                ),
                child: Row(
              ...
              remindersAsync.when(
                data: (reminders) {
                  ...
                  return ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return _buildMedicationRow(context, med, isDark);
                    },
                  );
                },
                ...
                error: (err, stack) => _buildEmptyState(context, isDark),
              ),
            ],
          ),
        ),
  ...
  Widget _buildMedicationRow(BuildContext context, Reminder med, bool isDark) {
