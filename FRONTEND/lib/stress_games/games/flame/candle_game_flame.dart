          ...
          particle: AcceleratedParticle(
            ...
            child: ComputedParticle(
              ...
              renderer: (canvas, particle) {
                ...
                final endColor = Colors.red.withOpacity(0.0);

                final paint = Paint()
                  ..color = Color.lerp(startColor, endColor, particle.progress)!
                      .withOpacity((1 - particle.progress) * intensity);
...
class LightingOverlay extends PositionComponent with HasGameRef<CandleGame> {
  double darkness = 0.5;
  ...
  void render(Canvas canvas) {
    ...
    final radius = (gameRef.size.length / 2) * (0.8 + (brightness * 0.5));

    final paint = Paint()
      ..shader = RadialGradient(
        colors: [
          Colors.black.withOpacity(darkness * 0.1),
